...
class AlexaSkillSpeechlet implements SpeechletV2{
	...
	private static String confirmEnglish = "Ab jetzt werde ich alle W�rter von englisch   auf deutsch �bersetzen.  viel spass beim lesen!";
	private static String confirmDeutsch = "Ab jetzt werde ich alle W�rter von englisch   auf deutsch �bersetzen.  viel spass beim lesen!";

	private static String correctAnswer = "";
	private static enum RecognitionState {Words, EnglishDeutsch};
	private RecognitionState recState;
	private static enum UserIntent {Englisch, Deutsch, Dog,  Cat, Window, Street,Table,Stop};
	...
	static String continueQuiz = "M�chten Sie weiterspielen?";
...
//			selectQuestion();
	...
	private SpeechletResponse evaluateAnswer(String userRequest) throws Exception {
		SpeechletResponse res = null;
		recognizeUserIntent(userRequest);
		switch (ourUserIntent) {
